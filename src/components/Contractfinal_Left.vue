<template>
    <div class='col-sm-12'>
        <form class="row g-3">
            ...
            <label>품목</label>
            <div class="col-5">
                <input class="form-select" v-model="category" readonly>
                    <!-- <option selected>상추</option>
                    <option>...</option>
                </select> -->
            </div>
            <div class="col-7">
                <input class="form-select" v-model="item" readonly>
            ...
            <div class="col-12">
                <label>계약면적</label>
                <input type="text" readonly v-model="area" class="form-control" id="rcvordAm" name="rcvordAm" numberOnlyMinComma="true" koreanCurrency="true" required="required" placeholder="입력단위: m2">
            </div>
        </form>
    </div>
</template>
